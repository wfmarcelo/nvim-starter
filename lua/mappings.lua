...
map("n", "<F8>",  function() require('dap').step_out() end,          { desc = "Debug: Step Out" })
...
map("n", "<F6>", function() require('neotest').run.run({strategy = 'dap'}) end, { desc = "Test: Debug Nearest" })

map("n", "<leader>rt", function() require('neotest').run.run() end,             { desc = "Test: Run Nearest" })
map("n", "<leader>rf", function() require('neotest').run.run(vim.fn.expand('%')) end, { desc = "Test: Run File" })
map("n", "<leader>rs", function() require('neotest').summary.toggle() end,      { desc = "Test: Toggle Summary" })
